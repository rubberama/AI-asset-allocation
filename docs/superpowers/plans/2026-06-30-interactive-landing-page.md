# Interactive Landing Page Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Upgrade the landing page at `frontend/app/page.tsx` to feature a highly interactive, responsive portfolio simulator with custom sliders, live SVG donut chart updates, and dynamic asset allocation metrics.

**Architecture:** Implement React state inside `LandingPage` component. Add sliders for Risk Tolerance and Global Equity Outlook. Build an SVG-based dynamic donut chart utilizing circumference stroke offsets, a live metrics card panel, and an asset weights breakdown with hover states. Style it with custom inline CSS using Spasex design tokens.
...
### Task 1: Implement Interactive Portfolio Simulator on Landing Page

Replace the static schematic and mockup in the landing page with the interactive simulator component, including the state handlers, SVG donut calculations, and custom sliders.
...
**Interfaces:**
* Consumes: None
* Produces: Fully interactive landing page at `/`.

- [ ] **Step 1: Write the updated landing page implementation**

Replace the contents of `C:/Users/hyunjaekim/Desktop/Etacolla/AI-asset-allocation/frontend/app/page.tsx` with the following code containing the full interactive simulator:
```tsx
"use client";
  ...
  const portfolio = useMemo(() => {
    ...
    return {
      weights: [
        ...
        { name: "해외채권", color: C.green2 || "#6EE7B7", value: wGlBond },
...
- [ ] **Step 3: Commit landing page improvements**

```bash
git add frontend/app/page.tsx
git commit -m "feat: upgrade landing page with live interactive portfolio simulator"
```
